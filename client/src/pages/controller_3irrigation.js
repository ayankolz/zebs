...
const Irrigation3 = () => {
    ...
    useEffect(() => {
        const fetchIrrigationData = async () => {
            try {
                const response = await fetch(`https://server-as46.onrender.com/auth/irrigation3`);
    ...
    return (
        <div className="irrigation-page-container">
            <h2 className="irrigation-title">Irrigation Data - Microcontroller 3</h2>
            {loading ? (
                <p>Loading...</p>
            ) : (
